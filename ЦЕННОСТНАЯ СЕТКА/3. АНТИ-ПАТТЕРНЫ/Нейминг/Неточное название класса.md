***
```url
github.com/jmuriki/WorthGrid/wiki/Неточное-название-класса#неточное-название-класса
```
...
***
```url
github.com/jmuriki/WorthGrid/wiki/Неточное-название-класса#service--paymentservice
```
...
***
```url
github.com/jmuriki/WorthGrid/wiki/Неточное-название-класса#converter--currencyconverter
```
...
***
```url
github.com/jmuriki/WorthGrid/wiki/Неточное-название-класса#person--employee
```
### Person / Employee
...
***
```url
github.com/jmuriki/WorthGrid/wiki/Неточное-название-класса#контакты
```
# [[Контакты]]
